    ...
    <div className="container mx-auto mt-9">
      <div className="flex mb-4 w-3/4">
        <button
          ...
          className={`py-8 px-5 w-1/2 text-lg font-semibold border transition-all duration-300 ease-in-out ${activeTab === "address"
        ...
        <button
          ...
          className={`py-8 px-5 w-1/2 text-lg font-semibold border transition-all duration-300 ease-in-out   ${activeTab === "payment"
              ? "border-b-4 border-[#73845e] py-4 text-[#73845e] "
      ...
      <div className="flex ">
        <div className="w-3/4  border border-[#ebecee] ">
          <div className="w-full">
            <div
              className={`p-8 border-b border-[#ebecee] transition-opacity duration-500 ease-in-out ${activeTab === "address" ? "opacity-100" : "opacity-0"
                }`}
            >
              {activeTab === "address" && (
                <div>
            ...
            <div
              className={`pb-14 px-8 border-b border-[#ebecee] transition-opacity duration-500 ease-in-out ${activeTab === "payment" ? "opacity-100" : "opacity-0"
                }`}
            >
              {activeTab === "payment" && (
                <div>
        ...
        <div className="w-1/4 pl-4">
          <div onClick={()=>handleToPaySuccessClick()} className="p-4 border border-[#ebecee] shadow-[0_1px_1px_rgba(41,50,63,0.04),_0_3px_4px_rgba(41,50,63,0.04)] rounded-lg space-y-4">
